...
import visualassistantfacv.VRMinerVisualAssistant_IGA;
 ...
 * @author Abdelheq
 */
public class IHM_Visual_Assistant extends javax.swing.JFrame {
    ...
    private List<Visualisation> liste, listdtm, listAttribute;
    private int idmethode, profilNum;
    public String filePathName, filePathNameExemple, imagedir = "images/", shape, afficherLiensS, jCheckBoxReseauS;
    ...
    public IHM_Visual_Assistant() throws Exception{
    ...
    private void initComponents() {
        ...
        loadXMLPreferencesUser = new javax.swing.JButton();
        ...
        ListProfil = new javax.swing.JList();
            ...
            .addGroup(DataSetPanelLayout.createSequentialGroup()
                .addGroup(DataSetPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(DataSetPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(DataSetPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(DataSetPanelLayout.createSequentialGroup()
                                .addComponent(filePath, javax.swing.GroupLayout.DEFAULT_SIZE, 405, Short.MAX_VALUE)
                                .addGap(64, 64, 64))
                            .addGroup(DataSetPanelLayout.createSequentialGroup()
        ...
        LaunchVisualizations.setText("Launch Actual Profil");
        ...
        AddNewProfil.setText("Add this Profil");
        ...
        VisualizationPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, VisualizationPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(AddNewProfil, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(AdjustIECButton, javax.swing.GroupLayout.DEFAULT_SIZE, 213, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        VisualizationPanelLayout.setVerticalGroup(
            ...
            .addGroup(VisualizationPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(OverviewPictureContainer, javax.swing.GroupLayout.DEFAULT_SIZE, 414, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(TauxSimilarite, javax.swing.GroupLayout.DEFAULT_SIZE, 15, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        AdjustPrefencesButton.setText("Save New Preferences");
        UserPreferencePanel.add(AdjustPrefencesButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 450, 170, -1));

        loadXMLPreferencesUser.setText("load User Preferences");
        loadXMLPreferencesUser.setPreferredSize(new java.awt.Dimension(161, 25));
        loadXMLPreferencesUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                loadXMLPreferencesUserActionPerformed(evt);
            }
        });
        UserPreferencePanel.add(loadXMLPreferencesUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(189, 450, 150, -1));
        ...
        UserPreferencePanel.add(loadXLSfile, new org.netbeans.lib.awtextra.AbsoluteConstraints(347, 450, 110, -1));
        ...
        bkgdColorView.setBackground(new java.awt.Color(204, 204, 255));
        ...
        All_UserObjective.setModel(AllExpertObjectiveListModel);
        ...
        Selected_UserObjective.setModel(ExpertObjectiveListModel);
        ...
        VisualCategoryListLabel.setText("All Visual Category :");
        OthersPanel.add(VisualCategoryListLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 22, -1, -1));

        VisualCategoryList.setModel(AllVisualizationCatgoryListModel);
        ...
        VisualDimensionListLabel.setText("Selected Visual Category :");
        OthersPanel.add(VisualDimensionListLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(236, 22, -1, -1));

        VisualDimensionList.setModel(VisualizationCatgoryListModel);
        ...
        ListProfil.setModel(ProfilListModel);
        jScrollPane1.setViewportView(ListProfil);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(UserPreferencePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 491, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addContainerGap())
            .addComponent(statusBar, javax.swing.GroupLayout.DEFAULT_SIZE, 1355, Short.MAX_VALUE)
        );
...
//                }
            ...
            filePathNameExemple = "C:\\Users\\Abdelheq\\Desktop\\Assistant Visuel\\XML Tests\\IRIS.xml";
            File fichier = new File(filePathName);
            List<Visualisation> listViusaAttribute = new LoadVisualizations().getIdMethode(1);
            try {
            new UpdateXMLFile(filePathNameExemple);
            } catch (Exception ex) {
            Logger.getLogger(IHM_Visual_Assistant.class.getName()).log(Level.SEVERE, null, ex);
            }
            for(int j=1; j<=5; j++){
                ...
                enregistreFichier(filePathNameExemple);
            }
...
//        filePathName = chooser.getSelectedFile().getAbsolutePath().toString();
        ...
        System.out.println("Add new Profil"+x);
        File fichier = new File(filePathName);
...
private void loadXMLPreferencesUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadXMLPreferencesUserActionPerformed
// TODO add your handling code here:
}//GEN-LAST:event_loadXMLPreferencesUserActionPerformed
...
//        System.out.println(" /:"+resultaMEC.size());
//        //initialiser le DefaultTableModel pour viusaliser le résultat du matching attributs de données / attributs visuels
...
//                //DB_VisualizationToolBar.add(progressBar);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        System.out.println("filePathNameExemple : "+filePathNameExemple);
        System.out.println("filePathName : "+filePathName);
        String path = filePathNameExemple;
            try {
                idmethode = idtable;
                //creer la scene 3D
                if(visu3D!=null){
...
//          Runtime.getRuntime().gc();
                ...
                updatePreview3D(path, idmethode);
                ...
                MatchingResult();
                List<ExpertObjective> expert_Allobjective_Liste = new LoadVisualizations().getAllExpertObjective();
                List<ExpertObjective> expert_objective_Liste = new LoadVisualizations().getExpertObjective(idmethode);
                List<CategorieVisualisation> Allcategorievisual_Liste = new LoadVisualizations().getAllCategorieVisualisation();
                List<CategorieVisualisation> categorievisual_Liste = new LoadVisualizations().getCategorieVisualisation(idmethode);
                List<Categorie> categorie_Liste = new LoadVisualizations().getCategorie(idmethode);
                List<String> profilList = new Matching().getProfiListe(filePathName);
                //List listeProfil = getProfilList(filePathName);

                AllExpertObjectiveListModel.removeAllElements();
                ExpertObjectiveListModel.removeAllElements();
                AllVisualizationCatgoryListModel.removeAllElements();
                VisualizationCatgoryListModel.removeAllElements();
                CatgoryListModel.removeAllElements();
                ProfilListModel.removeAllElements();
                
                for(int i=0; i<expert_Allobjective_Liste.size();i++){
                AllExpertObjectiveListModel.addElement(expert_Allobjective_Liste.get(i).getDescription());
                }
                for(int i=0; i<expert_objective_Liste.size();i++){
                ExpertObjectiveListModel.addElement(expert_objective_Liste.get(i).getDescription());
                }
                for(int i=0; i<Allcategorievisual_Liste.size();i++){
                AllVisualizationCatgoryListModel.addElement(Allcategorievisual_Liste.get(i).getNom());
                }
                ...
                ProfilListModel.addElement(profilList.get(i).toString());
                }
    ...
    */
    public static void main(String args[]) throws Exception{
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new IHM_Visual_Assistant().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(IHM_Visual_Assistant.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JList ListProfil;
    ...
    private javax.swing.JButton loadXMLPreferencesUser;
