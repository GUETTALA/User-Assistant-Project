 ...
 * @author Abdelheq
 */
public class VRMinerVisualAssistant1 extends javax.swing.JFrame {
    ...
    public VRMinerVisualAssistant1() throws Exception{
    ...
    private void initComponents() {
        ...
        AdjustIECButton.setText("Adjust This Configuration");
        ...
        VisualizationPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, VisualizationPanelLayout.createSequentialGroup()
                ...
                .addGap(30, 30, 30)
                .addComponent(AdjustIECButton, javax.swing.GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                .addGap(18, 18, 18)
...
//                }
            ...
            Logger.getLogger(VRMinerVisualAssistant1.class.getName()).log(Level.SEVERE, null, ex);
            }
            for(int j=1; j<=5; j++){
...
//                }
    ...
    private void AfficherIndividus(final String XMLFilepath) throws Exception {
        ...
        visu3D2.ConfigurationNuage3D(XMLFilepath, "profil"+2);
        visu3D2.createScene();
        ...
        visu3D3.ConfigurationNuage3D(XMLFilepath, "profil"+3);
        visu3D3.createScene();
        ...
        visu3D4.ConfigurationNuage3D(XMLFilepath, "profil"+4);
        visu3D4.createScene();
        ...
        visu3D5.ConfigurationNuage3D(XMLFilepath, "profil"+5);
        visu3D5.createScene();
    ...
    */
    public static void main(String args[]) throws Exception{
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new VRMinerVisualAssistant1().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(VRMinerVisualAssistant1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
